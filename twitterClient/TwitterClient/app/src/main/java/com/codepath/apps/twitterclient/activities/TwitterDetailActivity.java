...
//        textureView = (TextureView) findViewById(R.id.play_video_texture);
//        playerController = (MediaController.MediaPlayerControl) findViewById(R.id.play_video_controller);
    ...
    protected void onResume () {
        ...
        if (urlToDisplay != null) {
            Log.d(TAG, "URL to display = "+urlToDisplay);
            if ((urlToDisplay.endsWith(".jpeg")) || (urlToDisplay.endsWith(".jpg"))) {
                Log.d(TAG, "Display Image = "+urlToDisplay.toString());
